...
- 2026-09-24 OAuth administration candidate: the new Admin repository/Nancy-shaped graph and unchanged full Step 4B qualifier passed on fresh disposable PostgreSQL 16.15 targets at `eb98638419b63dca6a3bcbddf59dd69a4c42b984`. Independent review must reproduce the final commit, including the composite Nancy fixture coverage; neither local result is production approval or permission to enable OAuth.
